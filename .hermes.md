...
- 状態管理: Zustand
- 永続化: Dexie / IndexedDB
- 描画補助: Recharts, Framer Motion, Tailwind CSS
...
| CSS class | kebab-case | `surface-panel` |
...
2. realism / banzuke の quick report で分布を確認する
3. acceptance や Monte Carlo は最後の確認だけで回す
4. ディレクトリ責務を変えたら README を更新する
...
- 変更後は必ず、tests / quick report / README 更新のどれが必要かを明示的に判断する
