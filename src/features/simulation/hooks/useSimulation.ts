...
export const useSimulation = () => ({
  ...
  generationTokens: useSimulationStore((state) => state.generationTokens),
  observationPoints: useSimulationStore((state) => state.observationPoints),
  ...
  loadMetaProgress: useSimulationStore((state) => state.loadMetaProgress),
