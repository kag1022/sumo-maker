...
import { formatRankDisplayName } from "../utils/reportShared";
import styles from "./BoutExplanationPreviewPanel.module.css";
...
interface BoutExplanationPreviewPanelProps {
...
export const BoutExplanationPreviewPanel: React.FC<BoutExplanationPreviewPanelProps> = ({
  preview,
  bout,
  playerShikona,
  playerRank,
...
export const BoutExplanationPanel = BoutExplanationPreviewPanel;
