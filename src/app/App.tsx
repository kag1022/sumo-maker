...
function App() {
  ...
  const canToggleLogicLab = phase !== "running";
                  ...
                  <>
                    ...
                    {latestPauseReason && (
                      <div className="border-2 border-crimson bg-crimson-dim/10 p-4 glow-red">
                        <p className="ui-text-label text-crimson mb-1">
                          最終停止理由
                        </p>
                        <p className="text-xs sm:text-sm text-text-dim">{latestPauseReason}</p>
                      </div>
                    )}
                  </>
                )}
