...
const THROW_KIMARITE: OfficialKimariteEntry[] = [
  ...
  createOfficial({ officialOrder: 33, name: '下手投げ', class: 'THROW', family: 'THROW', primaryStyle: 'GRAPPLE', secondaryStyle: 'TECHNIQUE', rarityBucket: 'UNCOMMON', historicalWeight: 6.2, requiredPatterns: ['THROW_EXCHANGE', 'BELT_FORCE'], statAffinity: { nage: 0.82, kumi: 0.4, waza: 0.2 }, bodyAffinity: { preferredBodyTypes: ['NORMAL', 'MUSCULAR'], maxWeightDiff: 22 }, traitTags: ['YOTSU_NO_ONI'], signatureEligible: true, tags: ['belt'] }),
  createOfficial({ officialOrder: 34, name: '掬い投げ', class: 'THROW', family: 'THROW', primaryStyle: 'TECHNIQUE', secondaryStyle: 'GRAPPLE', rarityBucket: 'UNCOMMON', historicalWeight: 4.8, requiredPatterns: ['THROW_EXCHANGE'], statAffinity: { nage: 0.68, waza: 0.5, kumi: 0.2 }, bodyAffinity: { maxWeightDiff: 20 }, traitTags: ['ARAWAZASHI'], signatureEligible: true, tags: [] }),
  ...
  createOfficial({ officialOrder: 36, name: '上手出し投げ', class: 'THROW', family: 'THROW', primaryStyle: 'TECHNIQUE', secondaryStyle: 'GRAPPLE', rarityBucket: 'UNCOMMON', historicalWeight: 2.1, requiredPatterns: ['THROW_EXCHANGE', 'BELT_FORCE'], statAffinity: { nage: 0.74, waza: 0.55, kumi: 0.1 }, bodyAffinity: { maxWeightDiff: 18 }, traitTags: ['ARAWAZASHI', 'YOTSU_NO_ONI'], signatureEligible: true, tags: ['belt', 'rare'] }),
  createOfficial({ officialOrder: 37, name: '上手投げ', class: 'THROW', family: 'THROW', primaryStyle: 'GRAPPLE', secondaryStyle: 'TECHNIQUE', rarityBucket: 'UNCOMMON', historicalWeight: 7.4, requiredPatterns: ['THROW_EXCHANGE', 'BELT_FORCE'], statAffinity: { nage: 0.88, kumi: 0.45, power: 0.2 }, bodyAffinity: { preferredBodyTypes: ['NORMAL', 'MUSCULAR'], maxWeightDiff: 22 }, traitTags: ['YOTSU_NO_ONI'], signatureEligible: true, tags: ['belt'] }),
...
const SPECIAL_KIMARITE: OfficialKimariteEntry[] = [
  createOfficial({ officialOrder: 64, name: '叩き込み', class: 'SPECIAL', family: 'TWIST_DOWN', primaryStyle: 'TECHNIQUE', secondaryStyle: 'PUSH', rarityBucket: 'COMMON', historicalWeight: 10.5, requiredPatterns: ['PULL_DOWN'], statAffinity: { waza: 0.38, tsuki: 0.12, deashi: 0.22 }, bodyAffinity: { preferredBodyTypes: ['SOPPU', 'NORMAL'], maxWeightDiff: 22 }, traitTags: ['READ_THE_BOUT', 'OPENING_DASH'], signatureEligible: true, tags: ['pull'] }),
  createOfficial({ officialOrder: 65, name: '引き落とし', class: 'SPECIAL', family: 'TWIST_DOWN', primaryStyle: 'PUSH', secondaryStyle: 'TECHNIQUE', rarityBucket: 'COMMON', historicalWeight: 9.6, requiredPatterns: ['PULL_DOWN'], statAffinity: { tsuki: 0.22, oshi: 0.25, waza: 0.2 }, bodyAffinity: { preferredBodyTypes: ['SOPPU', 'NORMAL'], maxWeightDiff: 20 }, traitTags: ['THRUST_RUSH', 'OPENING_DASH'], signatureEligible: true, tags: ['pull'] }),
  ...
  createOfficial({ officialOrder: 69, name: '送り出し', class: 'SPECIAL', family: 'REAR', primaryStyle: 'TECHNIQUE', secondaryStyle: 'BALANCE', rarityBucket: 'UNCOMMON', historicalWeight: 1.8, requiredPatterns: ['REAR_CONTROL'], statAffinity: { deashi: 0.35, waza: 0.32 }, bodyAffinity: { maxWeightDiff: 22 }, traitTags: ['READ_THE_BOUT'], signatureEligible: true, tags: ['rear'] }),
  ...
  createOfficial({ officialOrder: 73, name: '送り倒し', class: 'SPECIAL', family: 'REAR', primaryStyle: 'TECHNIQUE', secondaryStyle: 'BALANCE', rarityBucket: 'RARE', historicalWeight: 0.12, requiredPatterns: ['REAR_CONTROL'], statAffinity: { waza: 0.62, deashi: 0.32 }, bodyAffinity: { maxWeightDiff: 18 }, traitTags: ['READ_THE_BOUT'], signatureEligible: true, tags: ['rear', 'rare'] }),
