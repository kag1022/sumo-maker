...
const cases: TestCase[] = [
  {
    name: 'ui: basho stake labels translate scheduler codes into UI copy',
    run: () => {
  ...
  {
    name: 'ui: live basho view prefers featured stakes over generic bouts',
    run: () => {
  ...
  {
    name: 'ui: banzuke review model summarizes empirical decision and nearby movement',
    run: () => {
