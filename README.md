...
各ディレクトリの詳細はサブ README に分離しています。全体像を掴むときは
以下の目次から読んでください。

- [src/features/README.md](./src/features/README.md) — 画面単位の feature 一覧
- [src/logic/README.md](./src/logic/README.md) — ドメインロジックのモジュール一覧
- [src/app/README.md](./src/app/README.md) — アプリシェル
- [src/shared/README.md](./src/shared/README.md) — 汎用 UI
- [scripts/README.md](./scripts/README.md) — tests / reports の配置と運用

コード側の規約は [CODING_GUIDELINES.md](./CODING_GUIDELINES.md)、
エージェント運用の方針は [AGENTS.md](./AGENTS.md) を参照してください。
